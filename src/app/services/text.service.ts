...
export enum T {
  ...
  photography_category1_subtitle = '>Placeholder for category 1 subtitle<',
  photography_category1_footer_message = '>Placeholder for category 1 footer message<',
  photography_category_2 = '>Placeholder for category 2<',
  photography_category2_subtitle = '>Placeholder for category 2 subtitle<',
  photography_category2_footer_message = '>Placeholder for category 2 footer message<',
  photography_category_3 = '>Placeholder for category 3<',
  photography_category3_subtitle = '>Placeholder for category 3 subtitle<',
  photography_category3_footer_message = '>Placeholder for category 3 footer message<',
  photography_category_4 = '>Placeholder for category 4<',
  photography_category4_subtitle = '>Placeholder for category 4 subtitle<',
  photography_category4_footer_message = '>Placeholder for category 4 footer message<',
