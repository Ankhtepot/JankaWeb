...
export class AboutMeComponent implements OnInit {
  ...
  ngOnInit(): void {
    this.profileImagePath = this.getRandomImage(Category.Profile);
    this.backgroundImageUrl = this.getRandomImage(Category.Paintings);
  ...
  getRandomImage(category: Category) {
    // change to all once all images are in place
    return this.imagesService.getRandomBackgroundImageUrl(category);
  }
