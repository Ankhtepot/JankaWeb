...
export class AboutMeComponent implements OnInit {
  ...
  ngOnInit(): void {
    this.profileImagePath = "assets/images/paintings/2.jpg";
    this.backgroundImageUrl = this.getRandomBackgroundImageUrl();
  ...
  getRandomBackgroundImageUrl() {
    // change to all once all images are in place
    return this.imagesService.getRandomBackgroundImageUrl(Category.Paintings);
  }
